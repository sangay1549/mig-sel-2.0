...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card bg-card text-card-foreground shadow-card flex flex-col gap-8 overflow-hidden rounded-lg p-6 text-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-5 data-[size=sm]:p-5 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg',
        className,
      )}
      {...props}
    />
